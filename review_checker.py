...
if __name__ == "__main__":
    ...
    review_text = "Должность: менеджер проектов Компания предоставляет все необходимые условия для работы: компьютеры, современный офис оплачиваемые отпуска и больничные, все нужное оборудование. Задачи реалные, интересные. Зарплату платят вовремя, есть премии за хорошую работу, очень даже стимулируют. Постояно проводятся мастер класы, курсы повышения навыков  я там много чему научилась и активно применяю в работе."
    gender = "Ж"
    model = "gpt-4o"
